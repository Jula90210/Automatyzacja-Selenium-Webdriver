...
class WizzairRegistration(unittest.TestCase):
    ...
    # Sprawdź czy treść jest poprawna: "Wpisz prawidłowy numer telefonu komórkowego.
        ...
        self.assertEqual(visible_errors[0].text, "Wpisz prawidłowy numer telefonu komórkowego.") #(prawie to samo czysty Python)
